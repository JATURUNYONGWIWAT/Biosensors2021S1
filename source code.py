...
df2 =pd.read_excel("Covid19_data/store.xlsx")       
x = df2["DATE"]
y = df2["store1"]
z = df2["store2"]
a = df2["store3"]
...
Death =pd.read_excel("Covid19_data/Death.xlsx")       
x = Death["DATE"]
y = Death["Death"]
plt.figure(figsize=(10, 6))
plt.grid(axis = 'y')
...
Deathslide =pd.read_excel("Covid19_data/Deathslide.xlsx")       
x1 = Deathslide["DATE"]
y1 = Deathslide["Death"]
plt.figure(figsize=(10, 6))
plt.grid(axis = 'y')
...
severelyill =pd.read_excel("Covid19_data/severely ill.xlsx")       
x2 = severelyill["DATE"]
...
ventilator =pd.read_excel("Covid19_data/ventilator.xlsx")       
x3 = ventilator["DATE"]
...
Fieldhospital =pd.read_excel("Covid19_data/Field hospital.xlsx")       
...
Homeorcommunity =pd.read_excel("Covid19_data/Home or community.xlsx")     
